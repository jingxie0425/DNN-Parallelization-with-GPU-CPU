...
int main(int argc, char **argv) {
    ...
    const char* Wdense3="../../../../graphGen/extractedParas/dense3Weight.csv";
    const char* Bdense3 = "../../../../graphGen/extractedParas/dense3Bias.csv";
    const char* Wdense4="../../../../graphGen/extractedParas/dense4Weight.csv";
    const char* Bdense4 = "../../../../graphGen/extractedParas/dense4Bias.csv";
    lide_c_graph_context_type *graph = NULL;
    graph = (lide_c_graph_context_type*)lide_c_cnnmulti_graph_new(InputsFile,
    Wconv1, Bconv1,
    Wconv2, Bconv2,
    Wdense1, Bdense1,
    Wdense2, Bdense2,
