#ifndef _lide_c_cnnsingle_graph_h
#define _lide_c_cnnsingle_graph_h
#include <stdio.h>
#include <stdlib.h>
...
#define ACTOR_MAXPOOL_max_pooling2d_2 5
#define FIFO_RELU2max_pooling2d_2 4
...
typedef struct _lide_c_cnnsingle_graph_context_struct lide_c_cnnsingle_graph_context_type;
lide_c_cnnsingle_graph_context_type *lide_c_cnnsingle_graph_new(const char * InputsFile, 
    ...
    const char* OutFile );
void lide_c_cnnsingle_graph_terminate(lide_c_cnnsingle_graph_context_type *graph);
void lide_c_cnnsingle_graph_scheduler(lide_c_cnnsingle_graph_context_type *graph);
#endif
